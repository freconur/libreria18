...
const RegistroVentas = () => {
  ...
  const { addProductRegisterToSell, LibraryData, showGenerateSale, stateLoader, resetValueToastify,sidebarSales, getDataUser, getDataUserContext } = useGlobalContext()
    ...
    <LayoutDashboard>
      ...
      <>
        ...
        <div className='relative  w-full px-1'>
          ...
          <div onClick={() => sidebarSales(true)} className='fixed text-xl border-[2px] md:hidden border-white text-white cursor-pointer bottom-[30px] right-[30px] rounded-full h-[51px] w-[51px] bg-green-400 shadow-md flex z-[400] justify-center items-center'>
            <p onClick={() => sidebarSales(true)}>$</p>
          </div>
